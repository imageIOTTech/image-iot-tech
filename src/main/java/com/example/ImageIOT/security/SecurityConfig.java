...
import com.example.ImageIOT.filter.JwtFilter;
import com.example.ImageIOT.service.CustomUserDetailsService;
        ...
        httpSecurity
                ...
                .oauth2Login(oauth2 -> oauth2
                        ...
                        .successHandler((req, res, auth) -> {
                            ...
                            res.sendRedirect("/api/auth/loginSuccess/" + provider);
                        })
